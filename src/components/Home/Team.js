...
function Team() {
  const ShilpaImg = cloudinaryUrl(
    'https://res.cloudinary.com/dhzg3dnfc/image/upload/v1732599937/rio_main_website/ywsej9hpk50pwaqbxwx4.jpg',
    { width: 320 }
  );
  const KavithImg = cloudinaryUrl(
    'https://res.cloudinary.com/dhzg3dnfc/image/upload/v1732599922/rio_main_website/s8yeutdgnpwkuw4balfk.jpg',
    { width: 320 }
  );
  const TonyImg = cloudinaryUrl(
    'https://res.cloudinary.com/dhzg3dnfc/image/upload/v1732599944/rio_main_website/vunzh9ywp4sxuouvt5g2.jpg',
    { width: 320 }
  );
  ...
  return (
    <div className='col-12'>
        <div className='team_intro'>
          <h2 className='team_title'>THE TRIO BEHIND RIO’S GROWTH</h2>
