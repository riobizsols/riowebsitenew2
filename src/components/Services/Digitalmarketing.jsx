...
function Digitalmarketing() {
  ...
  useEffect(() => {
    visitorTracking.trackServiceInterest('Digital Marketing');
  }, []);
  ...
  return (
    ...
    <div>
      <Helmet>
        <title>Digital Marketing Services | SEO, Content, Social Media, PPC | RioBizSols</title>
        <meta name="description" content="RioBizSols offers comprehensive digital marketing services including SEO, content marketing, social media marketing, PPC campaigns, and branding strategies to grow your business." />
        <meta name="keywords" content="digital marketing agency, digital marketing services, SEO services, content marketing, social media marketing, PPC campaigns, branding, search engine optimization" />
        <meta name="author" content="RioBizSols" />
        
        {/* Open Graph Tags */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Digital Marketing Services | SEO, Content, Social Media, PPC" />
        <meta property="og:description" content="Expert digital marketing services including SEO, content marketing, social media marketing, PPC, and branding to enhance your online visibility." />
        <meta property="og:url" content="https://riobizsols.com/our-service/digital-marketing" />
        <meta property="og:site_name" content="RioBizSols" />
        
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Digital Marketing Services | SEO, Content, Social Media, PPC" />
        <meta name="twitter:description" content="Comprehensive digital marketing solutions to boost your online presence and generate leads." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "name": "RioBizSols Digital Marketing Services",
            "description": "Comprehensive digital marketing services and strategies",
            "provider": {
              "@type": "Organization",
              "name": "RioBizSols"
            },
      ...
      <div className="container-digital">
        <img src={DM} alt="Digital Marketing Banner" className="digital-img" width={1200} height={500} style={{display: 'block', width: '100%', height: 'auto'}} />
      ...
      <div className='container'>
        <div className="container_digital_ser">
          <div className="images-column">
            <img src={digital2} alt="Digital Marketing Services" className="image-item" width={600} height={400} style={{display: 'block', width: '100%', height: 'auto'}} />
          </div>
      ...
      <div className="container_digital_ser1">
          ...
          <Link to='/contact'>
        <button className="get-started">CONTACT US <ArrowCircleRightIcon/></button></Link>
          </div>
         <div>
         <section className='digital_wapp'>
         <div className="black digital-grid">
          <img src={bp} alt="Branding" width={80} height={80} style={{display: 'block', width: '80px', height: 'auto'}} />
          <h5>Branding</h5>
          <p>We help you develop effective communication channels for your business.
          </p>
          </div>
          <div className="black digital-grid">
          <img src={plan} alt="Content Writing" width={80} height={80} style={{display: 'block', width: '80px', height: 'auto'}} />
          <h5>Content Writing</h5>
          <p>Our Content specialist helps you develop an effective strategy to attract potential customers.</p>
          </div>
         </section>
         <div className='digital_logo'><img src={logo} alt="RIO Logo" width={120} height={80} /></div>
         <section className='digital1_wapp'>
         <div className="black digital1-grid">
          <img src={time} alt="SEO Services" width={80} height={80} style={{display: 'block', width: '80px', height: 'auto'}} />
          <h5>SEO</h5>
          ...
          <div className="black digital1-grid">
          <img src={sm} alt="Social Media" width={80} height={80} style={{display: 'block', width: '80px', height: 'auto'}} />
          <h5>Social Media</h5>
      ...
      <div className="container_digital_ser1" style={{marginTop: 0, paddingTop: '60px', paddingBottom: '60px', gap: '40px'}}>
         <div className="text-column">
          <img src={service} alt="Digital Services" className="digital-ser-img" width={600} height={400} style={{display: 'block', width: '100%', height: 'auto'}} />
         ...
         <div className="text-column">
          ...
          <p className='digit-ser-para1'>RIO, a reliable Digital Marketing Agency possesses a team of experienced marketing experts who's ready to collaborate with you to understand your business needs and create a brand strategy that builds your brand equity, promotes its growth, and connects with the potential audience.</p>
      ...
      <div className="container_digital_ser1" style={{marginTop:0}}>
        ...
        <button className="get-started">CONTACT US <ArrowCircleRightIcon/></button></Link>
         ...
         <div className="digital1-grid2" >
          <img src={Google} alt="Google Analytics" style={{height:50, width:100, display: 'block'}} width={100} height={50} />
          <h6>GOOGLE <br/>ANALYTICS</h6>
            
          
          </div>
          <div className="digital1-grid2">
          <img src={GoogleSearch} alt="Google Search Console"  style={{height:50, width:100, display: 'block'}} width={100} height={50}/>
          <h6>GOOGLE <br/>SEARCH <br/>CONSOLE</h6>
         
          </div>
          <div className="digital1-grid2">
          <img src={ahrefs} alt="Ahrefs"  style={{height:50, width:100, display: 'block'}} width={100} height={50}/>
          <h6>AHREF</h6>
         ...
         <div className="digital1-grid2">
          <img src={Surfer} alt="Surfer" style={{height:50, width:100, display: 'block'}} width={100} height={50} />
          <h6>SURFER</h6>
          
          </div>
          <div className="digital1-grid2">
         
          <img src={keyword} alt="Keyword Everywhere" style={{height:70, width:100, display: 'block'}} width={100} height={70} />
          <h6>KEYWORD EVERYWHERE</h6>
          </div>
          <div className="digital1-grid2">
          <img src={semrush} alt="Semrush" style={{height:50, width:100, display: 'block'}} width={100} height={50} />
          <h6>SEMRUSH</h6>
          </div>
         </section> 
