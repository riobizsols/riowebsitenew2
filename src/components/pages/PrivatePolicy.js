...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: "20px" , background:"#EEF3F6"}}>
        <div className="container">
        <h1>Privacy Policy</h1>
      <p>Last updated: December 03, 2024</p>
      <p>
        Welcome to Riobizsols Pvt Ltd. This Privacy Policy explains how we
        collect, use, and safeguard your personal information when you visit
        our website at https://riobizsols.com.
      </p>
      ...
      <ul>
        ...
        <li>
        <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Rio Bizsols Pvt Ltd, No.174/96A, Barathi Colony Main Road, Peelamedu, Coimbatore, TN, 641004, India..
        </li>
        <li>
        ...
        <li>
        <strong>Website</strong> refers to Riobizsols, accessible from <Link to="https://riobizsols.com/">https://riobizsols.com/</Link>
        </li>
      </ul>
      ...
      <ul>
        <li><h5>Necessary / Essential Cookies</h5>
            <p>Type: Session Cookies</p>
            <p>Administered by: Us</p>
            <p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
        </li>
        <li><h5>Cookies Policy / Notice Acceptance Cookies</h5>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
            <p>Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
        </li>
        <li><h5>Functionality Cookies</h5>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
...
<ul>
 ...
 <p>We may share Your personal information in the following situations:</p>
  ...
  <ul>
    ...
    <p>The information gathered by Google Places is held in accordance with the Privacy Policy of Google: https://www.google.com/intl/en/policies/privacy/</p></li>
  </ul>
  ...
  <ul>
    <li>By visiting this page on our website: <Link to="/contact">our contact page</Link></li>
    <li>By address: No.174/96A, Barathi Colony Main Road, Peelamedu, Coimbatore, TN, 641004, India.</li>
  </ul>
        </div>
         </div>
  );
